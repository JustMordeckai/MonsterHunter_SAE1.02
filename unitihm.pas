...
begin
  ...
  begin
    ...
    deplacerCurseurXY(155,15); write('Experience : ',getPersonnage().experience:0:0,'/',getPersonnage().experienceMax:0:0);
    deplacerCurseurXY(155,16); write('     Level : ',getPersonnage().level);
